...
public static class Usb6210
{
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI8 = new(8);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI9 = new(9);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI10 = new(10);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI11 = new(11);
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI12 = new(12);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI13 = new(13);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI14 = new(14);
    /// <summary>
    /// Port for analog input.
    /// <list type="table">
    ...
    /// </list>
    /// </summary>
    public static readonly AnalogInputChannel AI15 = new(15);
}